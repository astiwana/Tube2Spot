 ...
 * the user's spotify id. Otherwise, we get a new token. 
 */
function checkToken() {
...
function loadPlaylists(params) {
    ...
    // Add the Liked Songs playlist manually
    ...
    .then(json => {
        ...
        json.items.forEach(playlist => {
            ...
            // Handle playlists with no images
        ...
        // Update paramters for the next batch of playlists
        params.offset += 50;
...
/**
 * Sends a PUT request to add the track specified to the Liked Songs playlist.
